...
La lista principal conserva estas cinco identidades:
...
slugs estáticos conocidos y no se reemplaza una fuente por una URL de evento o
de sesión.
...
calidad o país ni guardar tokens, firmas, URLs de sesión o respuestas efímeras.
