...
GitHub se autoriza por GitHub CLI en una ventana local separada. El token queda en el almacén administrado por `gh`; no se pide ni se escribe en el frontend. Publicar compara las tres versiones base de archivo para evitar sobrescribir cambios remotos y crea un único commit atómico en `SPxMM3R1/lista-m3u:main`. La cuenta debe tener permiso de escritura sobre ese repositorio.
